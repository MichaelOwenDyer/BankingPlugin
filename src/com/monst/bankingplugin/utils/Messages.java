...
public class Messages {
	...
	public static final String NO_PERMISSION_OTHER_BANK_CREATE = NO_PERMISSION + "create a bank in someone else's name."; // XXX
	public static final String NO_PERMISSION_OTHER_BANK_REMOVE = NO_PERMISSION + "remove someone else's bank."; // XXX
	public static final String NO_PERMISSION_OTHER_BANK_INFO = NO_PERMISSION + "view someone else's bank info."; // XXX
	public static final String NO_PERMISSION_OTHER_BANK_INFO_VERBOSE = NO_PERMISSION + "view someone else's detailed bank info."; // XXX
	public static final String NO_PERMISSION_OTHER_BANK_RESIZE = NO_PERMISSION + "resize someone else's bank."; // XXX

...
public class Messages {
	...
	private static final String accountCmd = Config.mainCommandNameAccount;
	private static final String bankCmd = Config.mainCommandNameBank;
	private static final String controlCmd = Config.mainCommandNameControl;
	...
	public static final String ACCOUNT_REMOVED_REFUND = ChatColor.GOLD + "The account has been removed and your account has been refunded.";
	public static final String ACCOUNT_BALANCE_NOT_ZERO = ChatColor.RED + "The account could not be removed because it is not empty.";
	...
	public static final String NOT_STANDING_IN_BANK = ChatColor.RED + "You must stand in or specify the name of the bank you want to remove.";
	...
	public static final String CLICK_CHEST_REMOVE = ChatColor.GOLD + "Click an account chest to remove it.";
	...
	public static final String NO_PERMISSION_ACCOUNT_VIEW_OTHER = NO_PERMISSION + "open someone else's account.";
	...
	public static final String COMMAND_USAGE_ACCOUNT_CREATE = ChatColor.RED + "Usage: /" + accountCmd + " create <playername>";
	public static final String COMMAND_USAGE_ACCOUNT_REMOVE = ChatColor.RED + "Usage: /" + accountCmd + " remove";
	public static final String COMMAND_USAGE_ACCOUNT_INFO = ChatColor.RED + "Usage: /" + accountCmd + " info <detailed>";
	public static final String COMMAND_USAGE_ACCOUNT_LIST = ChatColor.RED + "Usage: /" + accountCmd + " list <all> <detailed>";
	public static final String COMMAND_USAGE_ACCOUNT_LIMITS = ChatColor.RED + "Usage: /" + accountCmd + " limits";
	public static final String COMMAND_USAGE_ACCOUNT_REMOVEALL = ChatColor.RED + "Usage: /" + accountCmd + " removeall <playername / all / cancel>";
	public static final String COMMAND_USAGE_BANK_CREATE = ChatColor.RED + "Usage: /" + bankCmd + " create [name] <xyz> <xyz>";
	public static final String COMMAND_USAGE_BANK_REMOVE = ChatColor.RED + "Usage: /" + bankCmd + " remove <name>";
	public static final String COMMAND_USAGE_BANK_INFO = ChatColor.RED + "Usage: /" + bankCmd + " info <" + bankCmd + "name / all>";
	public static final String COMMAND_USAGE_BANK_LIST = ChatColor.RED + "Usage: /" + bankCmd + " list";
	//public static final String COMMAND_DESC_BANK_LIMITS = ChatColor.RED + "Usage: /" + bankCmd + " limits";
	public static final String COMMAND_USAGE_BANK_REMOVEALL = ChatColor.RED + "Usage: /" + bankCmd + " removeall";
	public static final String COMMAND_USAGE_RELOAD = ChatColor.RED + "Usage: /" + controlCmd + " reload";
	public static final String COMMAND_USAGE_CONFIG = ChatColor.RED + "Usage: /" + controlCmd + " config [set / add / remove] [field] <newvalue>";
	public static final String COMMAND_USAGE_UPDATE = ChatColor.RED + "Usage: /" + controlCmd + " update";

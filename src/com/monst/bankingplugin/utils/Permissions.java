...
public class Permissions {
	...
	public static final String ACCOUNT_INFO_OTHER = "bankingplugin.account.info-other-verbose";
	public static final String ACCOUNT_LIST_OTHER = "bankingplugin.account.list.other";
	public static final String ACCOUNT_LIST_OTHER_VERBOSE = "bankingplugin.account.list-other-verbose";
	...
	public static final String ACCOUNT_SET_MULTIPLIER_OTHER = "bankingplugin.account.set.multiplier.other";
	public static final String ACCOUNT_SET_INTEREST_DELAY_OTHER = "bankingplugin.account.set.interest-delay.other";
	...
	public static final String BANK_INFO_VERBOSE = "bankingplugin.bank.info.verbose"; // XXX
	public static final String BANK_LIST_VERBOSE = "bankingplugin.bank.list.verbose"; // XXX
